...
async function returnHTML(data){
      ...
      <table style="text-align:center;" bgcolor="#f5f5f5" align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
        <tbody>
          ...
          <br />
                ...
                We sent you a link to notify you that your password has been changed successfully and you can continue your session with your new access keys.
    ...
    <span style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder; text-align: center; display: block; margin-top: 75px;">
        ...
        <a href="https://ACCOUNT.live" style="display: inline-block; background: #2e58ff; color: white; font-family: Roboto, Helvetica, Arial, sans-serif; font-size: 13px; font-weight: normal; line-height: 30px; margin: 0; text-decoration: none; text-transform: none; padding: 6px 25px; width: 150px; mso-padding-alt: 0px; border-radius: 3px;" target="_blank">Log In Account</a>
