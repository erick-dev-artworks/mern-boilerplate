...
<title>Registration Code - ACCOUNT</title>
...
We sent you a code so we can prove it's your email, please confirm it when accessing or creating account 
<br />
<span style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder; text-align: center; display: block; margin-top: 96px;">
...
<span style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder; text-align: center; display: block; margin-top: 15px;">
																						
    Code will expire in 2 minutes: <br />
    ${link} <br />
