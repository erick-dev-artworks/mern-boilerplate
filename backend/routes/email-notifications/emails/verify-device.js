...
async function returnHTML(data){
    ...
    var location = data['country'] + ', ' + data['timezone']
    var accesstime = data['date']
...
<title>New Device - ACCOUNT</title>
...
Unrecognised device wants to access your account, please verify it's yours.
<br />
<span style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder; text-align: center; display: block; margin-top: 56px;">
																							...
																							<tbody>
																								<tr>
                                                                                                    <td style="font-size:0px; padding:10px 25px;word-break:break-word;">
                                                                                                      <div style="font-family:Roboto, Helvetica, Arial, sans-serif;font-size:18px; width: 420px; height: 320px; margin-top: 20px; font-weight:400;line-height:30px;text-align:left;color:#000;">
                                                                                                        <h1 align="center" style="margin: 0; font-size: 18px;  margin-top: 20px;">Device Details</h1>
                                                                                                
                                                                                                        <div style="width: 100%; display: flex; flex-direction: row; text-align: center; margin-top: 30px;">
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px;">Parameter</p>
                                                                                                            </div>
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px;">Value</p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div style="width: 100%; display: flex; flex-direction: row; text-align: center; ">
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">IP Address: </p>
                                                                                                            </div>
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">${address}</p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div style="width: 100%; display: flex; flex-direction: row; text-align: center;">
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">IP Location:</p>
                                                                                                            </div>
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">${location}</p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div style="width: 100%; display: flex; flex-direction: row; text-align: center;">
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">Device:</p>
                                                                                                            </div>
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">${system}</p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div style="width: 100%; display: flex; flex-direction: row; text-align: center;">
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">Browser: </p>
                                                                                                            </div>
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">${browser}</p>
                                                                                                            </div>
                                                                                                       ...
                                                                                                       <div style="width: 100%; display: flex; flex-direction: row; text-align: center;">
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">Access Time: </p>
                                                                                                            </div>
                                                                                                            <div style="width: 50%;">
                                                                                                                <p style="font-family:Roboto,SegoeUI,Helvetica,Arial,sans-serif;line-height:20px;font-size:14px;color:#3B3855; font-weight: bolder;margin-bottom: 0; font-size: 13px">${accesstime}</p>
                                                                                                            </div>
                                                                                                        </div>
				...
				<table style="text-align:center; margin-left: 150px;" width="439" bgcolor="#2c4bff" align="center" cellspacing="0" cellpadding="0" border="0">
					<tbody>
						<tr>
							...
							<!-- <td style="vertical-align:top;" width="439" bgcolor="#2c4bff" valign="top" align="center"><span style="color: #FFFFFF; font-family: Roboto, SegoeUI, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px;">
								We do respond to emails and you can reach us out in our discord group if you have a question.&nbsp;</span><br/>
								<span style="font-size:14px;line-height:20px;"> </span>
								<br style="font-size:14px;line-height:20px;"><a href="support@ACCOUNT.live" style="color: #FFFFFF; font-family: Roboto, SegoeUI, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; text-decoration: none;" target="_blank">
									<span style="color: #ffffff; font-family: Roboto, SegoeUI, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; text-decoration: none;">&gt;&nbsp;Email</span>
								</a>
								<br style="font-size:24px;line-height:24px;"><a href="https://www.ACCOUNT.live" style="color: #FFFFFF; font-family: Roboto, SegoeUI, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; text-decoration: none;" target="_blank">
								<span style="color: #ffffff; font-family: Roboto, SegoeUI, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; text-decoration: none;">&gt;&nbsp;Web</span>
								</a>
                                <br style="font-size:24px;line-height:24px;"><a href="https://www.ACCOUNT.live" style="color: #FFFFFF; font-family: Roboto, SegoeUI, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; text-decoration: none;" target="_blank">
                                    <span style="color: #ffffff; font-family: Roboto, SegoeUI, Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; text-decoration: none;">&gt;&nbsp;Discord</span>
                                    </a>
								</td> -->
						</tr>
					</tbody>
